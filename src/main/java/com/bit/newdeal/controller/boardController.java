...
=======
	...
	@RequestMapping("writeBoard.do")
	public String writeBoard(Board board, @RequestParam(value = "uFile", required = false) MultipartFile uFile,
			Principal principal, HttpServletRequest request) {
		String path = request.getSession().getServletContext().getRealPath("/");
		boardService.insertBoard(board, uFile, path, principal);
...
>>>>>>> master
	...
	// 댓글 수정
	@RequestMapping(value = "boardCommentUpdate.do", method = RequestMethod.PUT, headers = {
